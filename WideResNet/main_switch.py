...
parser.add_argument('--net_type', default='wide-resnet-switch', type=str, help='model')
...
def getNetwork(args):
    ...
    elif (args.net_type == 'wide-resnet-switch'):
        net = Wide_ResNet_Switch(args.depth, args.widen_factor, args.dropout, num_classes)
        file_name = 'wide-resnet-'+str(args.depth)+'x'+str(args.widen_factor)
    else:
...
if args.resume:
    ...
    net.load_state_dict(net.state_dict(), strict=False)
