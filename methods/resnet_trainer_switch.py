...
from results_switch_v3.methods import resnet_switch as resnet
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    os.makedirs("switches/Resnet56/", exist_ok=True)
    np.save("switches/Resnet56/ranks_ep_{epoch}.npy", feature_ranks)
